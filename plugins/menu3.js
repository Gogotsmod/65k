 ...
 if (teks == 'nsfw') tags = {
  ...
  try {
      ...
      const sections = [
   {
	...
	rows: [
	    {title: `📛)ഒ Info Bot`, rowId: ".info", description: "✧ Info nya GOGOTS BOT ><"},
	...
	{title: `💻)ഒ Bot Stats`, rowId: ".botinfo", description: "✧ Menampilkan Status 赤 GOGOTS - BOT"},
	{title: `📊)ഒ Test Speed`, rowId: ".testspeed", description: "✧ Test Install Speed BOT"},
	{title: `⚡)ഒ Speed`, rowId: ".speed", description: "✧ Kecepatan Respon 赤 GOGOTS - BOT..."},
	]
    },{
...
🌸 *Limit:* ${usrs.limit}
🌸 *Total Unreg:* ${Object.values(global.db.data.users).filter(user => user.registered == true).length}
🌸 *Total Reg:* ${Object.keys(global.db.data.users).length}
🌸 *Level:* ${usrs.level}
...
${clockStringP(usrs.premiumTime - new Date())}` : ''}
    ...
    🗓️ ${moment.tz('Asia/Jakarta').format('HH:mm:ss')}             
`
const listMessage = {
  text: tek,
  footer: '赤 GOGOTS- BOT',
